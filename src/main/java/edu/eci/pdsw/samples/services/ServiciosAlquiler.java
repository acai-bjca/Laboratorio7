...
public interface ServiciosAlquiler {
   ...
   * @return el listado de detalles de los items rentados por el cliente
   ...
   */
   ...
   public abstract List<Item> consultarItemsClienteSinDevoler(long idcliente) throws ExcepcionServiciosAlquiler;
